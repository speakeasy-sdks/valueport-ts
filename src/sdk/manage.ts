...
export class Manage {
  ...
  async apiKeyListPaged(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/api-keys/paged";
  ...
  async contractListPaged(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/contracts/paged";
  ...
  async customerListPaged(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/customers/paged";
  ...
  async equipmentListPaged(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/equipment/paged";
  ...
  async equipmentTypeCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/equipment-types";
  ...
  async equipmentTypeDelete(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/api/v1/manage/equipment-types/{id}",
      req
    );
  ...
  async equipmentTypeListPaged(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/equipment-types/paged";
  ...
  async tenantListPaged(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v1/manage/tenants/paged";
